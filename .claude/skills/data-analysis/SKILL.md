...
- **Save all scripts** with descriptive names (e.g., in a project scripts directory)
- **Save all outputs** (figures, tables, RDS) to `output/`
- **Use `saveRDS()`** for every computed object — downstream slides may need them
...
"Review the script at [script_path]/[script_name].R"
```
