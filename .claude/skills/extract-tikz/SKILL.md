---
name: extract-tikz
description: Extract TikZ diagrams from Beamer source, compile to PDF, convert to SVG with 0-based indexing. Use when updating TikZ diagrams for standalone SVG output.
...
Extract TikZ diagrams from the Beamer source, compile to multi-page PDF, and convert each page to standalone SVG.
